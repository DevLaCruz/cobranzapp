...
<head>
  ...
  <?php
$mode = isset($_COOKIE['theme_mode']) ? $_COOKIE['theme_mode'] : 'dark'; // Puedes usar localStorage o sessionStorage en lugar de cookies
...
?>
  ...
  <?php if ($uri == "/cobranza-app/" || $uri == "/cobranza-app/index.php"): ?>
